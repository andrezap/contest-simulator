...
final class Version20200625225452 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE round_contestant (id UUID NOT NULL, contestant_id UUID DEFAULT NULL, round_id UUID DEFAULT NULL, score DOUBLE PRECISION NOT NULL, final_score DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE contest (id UUID NOT NULL, active BOOLEAN NOT NULL, judges JSON NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE round_contestant ALTER final_score TYPE INT');
        $this->addSql('ALTER TABLE round_contestant ALTER final_score DROP DEFAULT');
        $this->addSql('ALTER TABLE contestant ADD winner BOOLEAN NOT NULL DEFAULT FALSE');
        $this->addSql('ALTER TABLE contestant ALTER winner DROP DEFAULT');
    }
